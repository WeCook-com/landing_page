                                ...
                                <div className=" my-auto">
                                    <div className="mt-5 w-full max-w-sm m-auto px-6 py-8 bg-white dark:bg-slate-900 rounded-md shadow-lg shadow-slate-500 dark:shadow-slate-800">
                                        <div className="grid grid-cols-1">
                                            ...
                                            <p className="text-slate-400 dark:text-slate-300 mb-6 text-center">
                                            ...
                                            <form className="ltr:text-left rtl:text-right">
                                                <div className="grid grid-cols-1">
                                                    ...
                                                    <div className="mb-4">
                                                        <Link
                                                            href="#"
                                                            className="btn bg- hover:bg-orange-700 border- hover:border-orange-700 text-white rounded-md w-full"
                                                        >
                                                            Send
                                                        </Link>
                                                    </div>
